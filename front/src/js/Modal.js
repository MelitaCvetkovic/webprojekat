...
<div class="modal" tabindex="-1" role="dialog" id="modal">
    ...
    <div class="modal-content">
        ...
        <button type="button" class="btn btn-primary" id="edit-book">Save changes</button>
        <button type="button" class="btn btn-danger" id="delete-book">Close</button>
        </div>
    </div>
    </div>
</div>
...
export class Modal {
    ...
    static openBookInfoModal(book, html, classNames) {
        ...
        api.fetchOrderUserByBook(book.id).then(res => {
            let title = book.name + "(" + book.numberPages + " pages)"
            ...
            document.querySelectorAll('.modal .modal-body').forEach(modal => {
                console.log(modal, user_container);
